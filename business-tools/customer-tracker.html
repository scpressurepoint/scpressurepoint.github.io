...
<body>
    ...
    <script>
        ...
        function loadMapsScript() {
            ...
            script.src = `https://maps.googleapis.com/maps/api/js?key=${MAPS_API_KEY}&libraries=places&callback=initMapsAutocomplete`;
            script.async = true;
            script.defer = true;
        ...
        function initMapsAutocomplete() {
            ...
            if (!document.querySelector('#maps-autocomplete-style')) {
                const style = document.createElement('style');
                style.id = 'maps-autocomplete-style';
                style.textContent = `
                    .pac-container { background: #1e293b; border: 1px solid #334155; border-radius: 12px; margin-top: 4px; font-family: system-ui; z-index: 9999; }
